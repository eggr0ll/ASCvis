...
# rename columns
final_df.rename(columns={'percent-attendance-total': 'percent_attendance_total', 'percent-attendance-cty': 'percent_attendance_cty', 'CTYNAME': 'NAME'}, inplace=True)

# create map
fig = px.choropleth(data_frame=final_df, locations='NAME', geojson=counties, color='percent_attendance_total',
